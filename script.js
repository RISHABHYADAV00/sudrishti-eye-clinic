...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (bookingForm) {
        bookingForm.addEventListener('submit', (e) => {
            ...
            // Send via EmailJS
            emailjs.send("service_sxsul9i", "template_ioukuyv", formData)
                .then(() => {
                    // Success UI
                    ...
                    setTimeout(() => {
                        ...
                        btn.disabled = false;
                        bookingForm.reset();
                        alert(`Thank you ${formData.name}! Your appointment request for ${formData.date} at ${formData.time} has been sent successfully.`);
                    }, 2000);
                }, (error) => {
                    // Error UI
                    ...
                    btn.style.background = 'var(--primary-blue)';
                    btn.disabled = false;
                    alert('Oops! Something went wrong and we couldn\'t send your request. Please try calling us directly instead.');
                });
        });
    }
